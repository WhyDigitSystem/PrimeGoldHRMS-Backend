...
public class BasicMasterController extends BaseController {
	...
	//ApprovedCheckout
		...
		public ResponseEntity<ResponseDTO> getRequestCheckOutByOrgId(@RequestParam Long orgId,@RequestParam String branch,@RequestParam String reportingPersoncode) {
	...
	public ResponseEntity<ResponseDTO> createApprovalCheckOut(@RequestParam Long orgId, 
	        ...
	        @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) String checkOutDate,@RequestParam String notifyCode, @RequestParam String notify, @RequestParam String screenName) {
	    ...
	    try {
	        // Convert checkOutDate from String to LocalDate
	          ...
	          Map<String, Object> checkInVO = basicMasterService.createApprovalCheckOut(
	                  orgId, employeeCode, action, actionBy, localCheckOutDate, notifyCode, notify,screenName);
	...
	public ResponseEntity<ResponseDTO> createCheckInOutAdjustment(@RequestBody CheckInOutAdjustmentDTO checkInOutAdjustmentDTO) {
	...
	public ResponseEntity<ResponseDTO> createApprovalCheckInOutAdjustment(
	    ...
	    try {
	        ...
	        // Call the service
	        Map<String, Object> result = basicMasterService.createApprovalCheckInOutAdjustment(
	                orgId, employeeCode, action, actionBy, localCheckOutDate, notifyCode, notify,screenName);

	        // ✅ Extract and flatten
	        List<CheckInOutAdjustmentVO> adjustmentList =
	                (List<CheckInOutAdjustmentVO>) result.get("checkInOutAdjustmentList");
	...
	public ResponseEntity<ResponseDTO> getRequestCheckInOutByOrgId(@RequestParam Long orgId,@RequestParam String branch,@RequestParam String reportingPersoncode) {
		String methodName = "getRequestCheckOutByOrgId()";
		LOGGER.debug(CommonConstant.STARTING_METHOD, methodName);
		String errorMsg = null;
		Map<String, Object> responseObjectsMap = new HashMap<>();
	...
	public ResponseEntity<ResponseDTO> getAllHolidayByOrgId(@RequestParam Long orgId) {
		...
		if (StringUtils.isBlank(errorMsg)) {
			...
			responseDTO = createServiceResponseError(responseObjectsMap,
					"Holiday information receive failed By OrgId", errorMsg);
		}
		LOGGER.debug(CommonConstant.ENDING_METHOD, methodName);
		return ResponseEntity.ok().body(responseDTO);
	...
	public ResponseEntity<ResponseDTO> getStatusByEmpcode(@PathVariable String empcode) {
	    ...
	    try {
	        ...
	        LOGGER.error(UserConstants.ERROR_MSG_METHOD_NAME, methodName, errorMsg);
	        responseDTO = createServiceResponseError(responseObjectsMap, "Failed to retrieve Employee Status", errorMsg);
	...
	public ResponseEntity<ResponseDTO> getAttendanceByEmpcode(
	    ...
	    try {
	        ...
	        List<Map<String, Object>> attendanceList = basicMasterService.getAttendanceByEmpcode(
	                empcode, monthInt, orgId, branch, branchCode
	        );
	...
	public ResponseEntity<ResponseDTO> excelUploadForChargeCode(@RequestParam MultipartFile[] files,
		...
		try {
			...
			responseDTO = createServiceResponseError(responseObjectsMap, "Excel Upload For Holidays Failed",
					errorMsg);
		}
		LOGGER.debug(CommonConstant.ENDING_METHOD, methodName);
		return ResponseEntity.ok().body(responseDTO);
...
/// circular
	...
	public ResponseEntity<ResponseDTO> getAllCircularByOrgId(@RequestParam Long orgId,@RequestParam String branchCode,@RequestParam(required = false) String department
,@RequestParam String type) {
		...
		if (StringUtils.isBlank(errorMsg)) {
			...
			responseDTO = createServiceResponseError(responseObjectsMap,
					"Circular information receive failed By OrgId", errorMsg);
		}
		LOGGER.debug(CommonConstant.ENDING_METHOD, methodName);
		return ResponseEntity.ok().body(responseDTO);
	...
	public ResponseEntity<ResponseDTO> getAllPollsByOrgId(@RequestParam Long orgId,@RequestParam String branchCode,@RequestParam(required = false) String department
,@RequestParam String type) {
		...
		if (StringUtils.isBlank(errorMsg)) {
			...
			responseDTO = createServiceResponseError(responseObjectsMap,
					"polls information receive failed By OrgId", errorMsg);
		}
		LOGGER.debug(CommonConstant.ENDING_METHOD, methodName);
		return ResponseEntity.ok().body(responseDTO);
	...
	public ResponseEntity<ResponseDTO> getPollResultForUser(@RequestParam Long orgId,String userName,Long pollId) {
		...
		if (StringUtils.isBlank(errorMsg)) {
			...
			responseDTO = createServiceResponseError(responseObjectsMap, "User Poll Result to retrieve Customer Details",
					errorMsg);
		}
	...
	public ResponseEntity<ResponseDTO> GetAnnouncementByOrgId(@RequestParam Long orgId,@RequestParam String branchCode) {
	...
	public ResponseEntity<ResponseDTO> GetAnnouncementById(@RequestParam Long id) {
		...
		if (StringUtils.isBlank(errorMsg)) {
			...
			responseDTO = createServiceResponseError(responseObjectsMap, "AnnouncementVO information receive failedById",
					errorMsg);
		}
		LOGGER.debug(CommonConstant.ENDING_METHOD, methodName);
		return ResponseEntity.ok().body(responseDTO);
    ...
    //Praise//
	  ...
	  @GetMapping("/GetCountOfPraiseByOrgIdAndCircularId")
		public ResponseEntity<ResponseDTO> GetCountOfPraiseByOrgIdAndCircularId(@RequestParam Long circularid, Long orgId) {
			...
			if (StringUtils.isBlank(errorMsg)) {
				responseObjectsMap.put(CommonConstant.STRING_MESSAGE, "Count of praise get successfully By circularId and  OrgId");
	  ...
	  @GetMapping("/GetNewTask")
		public ResponseEntity<ResponseDTO> GetNewTask(@RequestParam String AssignedTo, Long orgId) {
			...
			if (StringUtils.isBlank(errorMsg)) {
				...
				responseDTO = createServiceResponseError(responseObjectsMap,
						"new task failed for user and  OrgId", errorMsg);
			}
			LOGGER.debug(CommonConstant.ENDING_METHOD, methodName);
			return ResponseEntity.ok().body(responseDTO);
	  ...
	  @GetMapping("/GetPendingTask")
		public ResponseEntity<ResponseDTO> GetPendingTask(@RequestParam String AssignedTo, Long orgId) {
			...
			if (StringUtils.isBlank(errorMsg)) {
				...
				responseDTO = createServiceResponseError(responseObjectsMap,
						"Pending task failed for user and  OrgId", errorMsg);
			}
			LOGGER.debug(CommonConstant.ENDING_METHOD, methodName);
			return ResponseEntity.ok().body(responseDTO);
	  ...
	  @GetMapping("/GetCountofPendingTask")
		public ResponseEntity<ResponseDTO> GetCountofPendingTask(@RequestParam String AssignedTo, Long orgId) {
			...
			if (StringUtils.isBlank(errorMsg)) {
				responseObjectsMap.put(CommonConstant.STRING_MESSAGE, "Count of Pending task get successfully For user and  OrgId");
				responseObjectsMap.put("taskVO", taskVO);
				responseDTO = createServiceResponse(responseObjectsMap);
			} else {
				responseDTO = createServiceResponseError(responseObjectsMap,
	  ...
	  @GetMapping("/GetCountofNewTask")
		public ResponseEntity<ResponseDTO> GetCountofNewTask(@RequestParam String AssignedTo, Long orgId) {
			...
			if (StringUtils.isBlank(errorMsg)) {
				responseObjectsMap.put(CommonConstant.STRING_MESSAGE, "Count of New task get successfully For user and  OrgId");
				responseObjectsMap.put("taskVO", taskVO);
				responseDTO = createServiceResponse(responseObjectsMap);
			} else {
				responseDTO = createServiceResponseError(responseObjectsMap,
						"Count of New task failed for user and  OrgId", errorMsg);
			}
			LOGGER.debug(CommonConstant.ENDING_METHOD, methodName);
			return ResponseEntity.ok().body(responseDTO);
...
//
	  ...
	  @GetMapping("/GetNewAssignedTask")
		public ResponseEntity<ResponseDTO> GetNewAssignedTask(@RequestParam String AssignedBy, Long orgId) {
			...
			if (StringUtils.isBlank(errorMsg)) {
				responseObjectsMap.put(CommonConstant.STRING_MESSAGE, "new task get successfully For Assigned by  and  OrgId");
				responseObjectsMap.put("taskVO", taskVO);
				responseDTO = createServiceResponse(responseObjectsMap);
			} else {
				responseDTO = createServiceResponseError(responseObjectsMap,
						"new task failed for Assigned by  and  OrgId", errorMsg);
			}
			LOGGER.debug(CommonConstant.ENDING_METHOD, methodName);
			return ResponseEntity.ok().body(responseDTO);
	  ...
	  @GetMapping("/GetPendingAssignedTask")
		public ResponseEntity<ResponseDTO> GetPendingAssignedTask(@RequestParam String AssignedBy, Long orgId) {
			...
			if (StringUtils.isBlank(errorMsg)) {
				responseObjectsMap.put(CommonConstant.STRING_MESSAGE, "Pending task get successfully For Assigned by and  OrgId");
				responseObjectsMap.put("taskVO", taskVO);
				responseDTO = createServiceResponse(responseObjectsMap);
			} else {
				responseDTO = createServiceResponseError(responseObjectsMap,
	  ...
	  @GetMapping("/GetCountofPendingAssignedTask")
		public ResponseEntity<ResponseDTO> GetCountofPendingAssignedTask(@RequestParam String AssignedBy, Long orgId) {
			...
			if (StringUtils.isBlank(errorMsg)) {
				responseObjectsMap.put(CommonConstant.STRING_MESSAGE, "Count of Pending task get successfully For Assinged By and  OrgId");
				responseObjectsMap.put("taskVO", taskVO);
				responseDTO = createServiceResponse(responseObjectsMap);
			} else {
				responseDTO = createServiceResponseError(responseObjectsMap,
	  ...
	  @GetMapping("/Getworkaniversary")
		...
		public ResponseEntity<ResponseDTO> getpayslipemployeedetails(@RequestParam Long orgId,String Employeecode) {
			...
			if (StringUtils.isBlank(errorMsg)) {
				...
				responseDTO = createServiceResponseError(responseObjectsMap, "Payslip Employee to retrieve Charge Type", errorMsg);
			}
		...
		public ResponseEntity<ResponseDTO> getpayslipearningdetails(@RequestParam Long orgId,String Employeecode, Long Month,Long year) {
			...
			if (StringUtils.isBlank(errorMsg)) {
				...
				responseDTO = createServiceResponseError(responseObjectsMap, "Payslip Earnings  retrievd unsucessful", errorMsg);
			}
		...
		public ResponseEntity<ResponseDTO> getpayslipdeductiondetails(@RequestParam Long orgId,String Employeecode,Long Month,Long year) {
			...
			if (StringUtils.isBlank(errorMsg)) {
				...
				responseDTO = createServiceResponseError(responseObjectsMap, "Payslip deduction  retrievd unsucessful", errorMsg);
			}
		...
		public ResponseEntity<ResponseDTO> getpayslipCompanydetails(@RequestParam Long orgId) {
			...
			if (StringUtils.isBlank(errorMsg)) {
				...
				responseDTO = createServiceResponseError(responseObjectsMap, "Payslip Company Details retrieve Charge Type", errorMsg);
			}
		...
		public ResponseEntity<ResponseDTO> getpaysliphandsondetails(@RequestParam Long orgId,String Employeecode, Long Month,Long year) {
			...
			if (StringUtils.isBlank(errorMsg)) {
				...
				responseDTO = createServiceResponseError(responseObjectsMap, "Payslip handson retrievd unsucessful", errorMsg);
			}
		...
		public ResponseEntity<ResponseDTO> getTodayAttendanceReportByOrgId(@RequestParam Long orgId,@RequestParam String branch,@RequestParam String date) {
		...
		public ResponseEntity<ResponseDTO> getAllCalendarByOrgId(@RequestParam Long orgId,@RequestParam String branchCode,@RequestParam String empCode) {
			...
			if (StringUtils.isBlank(errorMsg)) {
				...
				responseDTO = createServiceResponseError(responseObjectsMap,
						"Calendar information receive failed By OrgId", errorMsg);
			}
			LOGGER.debug(CommonConstant.ENDING_METHOD, methodName);
			return ResponseEntity.ok().body(responseDTO);
		...
		public ResponseEntity<ResponseDTO> getApprovalPendingCountForDashBoard( @RequestParam Long orgId,@RequestParam String reportingPersonCode,@RequestParam String branchCode) {
			...
			try {
				approvalCount = basicMasterService.getApprovalPendingCountForDashBoard(orgId,reportingPersonCode, branchCode);
				...
				String errorMsg = e.getMessage();
				LOGGER.error(UserConstants.ERROR_MSG_METHOD_NAME, methodName, errorMsg);
				responseDTO = createServiceResponseError(responseObjectsMap, "Failed to retrieve approvalCount details", errorMsg);
			}
...
//CalendarNotification		
		...
		public ResponseEntity<ResponseDTO> getCalendarNotificationByOrgId(@RequestParam Long orgId,@RequestParam String branchCode,@RequestParam String empCode) {
			...
			if (StringUtils.isBlank(errorMsg)) {
				responseObjectsMap.put(CommonConstant.STRING_MESSAGE, "Calendar Notification information get successfully By OrgId");
				responseObjectsMap.put("calendarVO", calendarVO);
				responseDTO = createServiceResponse(responseObjectsMap);
			} else {
				responseDTO = createServiceResponseError(responseObjectsMap,
