...
//	List<Object[]> findpayslipearningsdetails(Long orgId, String employeeCode, Long month, Long year);
	...
	@Query(nativeQuery = true, value = "SELECT \r\n"
			...
			+ "    payslipeffectivedate\r\n"
			+ "FROM (\r\n"
			+ "    -- Individual earnings from salarystructure\r\n"
			+ "    SELECT \r\n"
			+ "        b.employeename,\r\n"
			+ "        b.orgid,\r\n"
			+ "        b.employeecode,\r\n"
			...
			+ "        s.totalcompanyworkingdays,\r\n"
			+ "        s.empsalarydays,\r\n"
			+ "        s.otamount AS actuals,  -- no proration, full OT amount\r\n"
			+ "        a.payslipeffectivedate\r\n"
			+ "    FROM \r\n"
			+ "        salaryprocess s\r\n"
			...
			+ "        '' AS employeecode,\r\n"
			+ "        'Total Earnings' AS heading,\r\n"
			+ "        SUM(d.amount) + MAX(s.otamount) AS amount,   -- add OT here\r\n"
			+ "        0 AS totalcompanyworkingdays,\r\n"
			+ "        0 AS empsalarydays,\r\n"
			+ "        SUM(ROUND((d.amount / s.totalcompanyworkingdays) * s.empsalarydays, 0)) + MAX(s.otamount) AS actuals,\r\n"
			+ "        a.payslipeffectivedate\r\n"
			+ "    FROM \r\n"
			+ "        salarystructure b,\r\n"
			+ "        employee a,\r\n"
